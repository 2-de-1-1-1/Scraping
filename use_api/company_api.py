...
if __name__ == "__main__":
        ...
        if response.status_code == 200:
            ...
            for job_data in data['jobPositions']:
                ...
                if company_info:
                    ...
                    if company_id not in processed_companies:  # 기업 ID가 처리되지 않았을 경우에만 진행
                        processed_companies.add(company_id)  # 기업 ID를 처리된 기업 집합에 추가
    ...
    jobs_output_file = os.path.join(data_folder, 'company_api.json')
